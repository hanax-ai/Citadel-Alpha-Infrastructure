...
## Executive Summary
This specification details the complete deployment of the **Citadel API Gateway Enhanced Edition** on HX-Server-02 (192.168.10.29). The implementation provides a production-ready AI inference platform with agent-optimized streaming, enterprise audit capabilities, comprehensive model management, and real-time system monitoring.
...
server {
    listen 80;
    listen [::]:80;
    server_name 192.168.10.29 llm-02 hx-server-02;
...
## Production Server: HX-Server-02 (192.168.10.29)
...
```bash
curl -X POST http://192.168.10.29/v1/voice/chat/completions \
  -H "Content-Type: application/json" \
...
curl http://192.168.10.29/management/models/list

# Check system resources
curl http://192.168.10.29/management/system/resources

# Monitor service health
curl http://192.168.10.29/health
```
EOF
...
### Service Endpoints
- **HTTP**: http://192.168.10.29 (port 80)
- **HTTPS**: https://192.168.10.29 (port 443)
- **Direct**: http://192.168.10.29:8002 (internal)
