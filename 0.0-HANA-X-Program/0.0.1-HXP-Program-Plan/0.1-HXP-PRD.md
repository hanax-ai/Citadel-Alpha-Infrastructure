...
* **🧠 AI Engine:** Optimized LLM inference framework for enterprise workloads, exposed via an OpenAI-compatible API.
...
* **Project 3: `hx-llm-server-01` Setup:** Provision and configure the primary LLM inference engine, serving AI models via an OpenAI-compatible API.
