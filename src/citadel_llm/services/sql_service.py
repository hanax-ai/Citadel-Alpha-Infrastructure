...
class SQLService:
    ...
    def __init__(self, config_path: Optional[str] = None, credentials_path: Optional[str] = None):
        ...
        self.config_path = config_path or "/opt/citadel-02/config/services/integration/sql-database.yaml"
        self.credentials_path = credentials_path or "/opt/citadel-02/config/secrets/database-credentials.yaml"
    ...
    def _get_connection_string(self) -> str:
        ...
        return (
            ...
            f"{db_creds['host']}:{db_creds['port']}/{db_creds['database']}{ssl_param}"
        )
